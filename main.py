...
pygame.display.set_caption("snack code with Durgesh")
...
while True:
    ...
    if snake_position[0] == food_position[0] and snake_position[1] == food_position[1] or pygame.Rect(food_position[0],
                                                                                                      food_position[1],
                                                                                                      10,
                                                                                                      10).collidepoint(
